...
/**
 * @author Marcelo Criscuolo (Jau) - criscuolo.marcelo (at) gmail (dot) com
 *
 */
public class CurrencyWriterUtil {
	...
	/**
	 * O conversor reconhece numeros ate a ordem dos setilhoes, portanto, o
	 * maior valor suportado atualmente e o representado abaixo.
	 */
	private static final BigDecimal MAX_SUPPORTED_VALUE = new BigDecimal("999999999999999999999999999.99");


	public CurrencyWriterUtil() {
	...
	public String write(final BigDecimal amount) {
		...
		/* Se o numero estiver, digamos, na casa dos milhoes, a pilha 
		 * devera conter 4 elementos sendo os dois ultimos os das 
		...
		while (!decomposed.empty()) {
			...
			switch (expoente) { // TODO ao inves desses switches e ifs, partir para a ideia das "Pendencias"; talvez implementa-las com enum
			case 0:
